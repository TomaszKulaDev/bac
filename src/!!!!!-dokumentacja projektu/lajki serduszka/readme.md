...
4. Komponent ActionButtons.tsx w folderze app/muzyka/component
        - Alternatywny interfejs lajkowania
        - Integracja z systemem autoryzacji
        - Wyświetlanie stanu polubień
        - Obsługa logiki serduszka w komponencie
        - Wywołanie handleLike z useLike
        - Renderowanie przycisków serduszka
        - Implementacja przycisku serduszka
        - Wyświetlanie liczby polubień
        - Obsługa interakcji użytkownika

            Kod: export const ActionButtons: React.FC<ActionButtonsProps> = ({
        currentSongId,
        onLike,
        isLiked,
        onCreatePlaylist,
