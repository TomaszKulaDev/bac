...
const ArticleCard = ({
  ...
  const author = useMemo(() => {
    const authorIndex = index % AUTHORS.videoAuthors.length;
    return AUTHORS.videoAuthors[authorIndex];
  }, [index]);
...
export default function NewsGridTopVideoDance() {
  return (
            ...
            <div className="mb-2">
              <div className="flex items-center">
                <div className="bg-[#ffd200] rounded-md w-6 h-6 flex items-center justify-center mr-1.5">
                  <span className="font-bold text-black text-xs">T</span>
                </div>
                <h2 className="text-xs font-bold uppercase">TANIEC</h2>
              </div>
            </div>
